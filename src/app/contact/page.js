            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  Whether you're planning a new construction project, renovation, or just have questions 
                  about our services, we're here to help. Our team of experts is ready to bring your vision to life.
                </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">hello@moulvision.com</p>
                    </div>
                  </div>
              ...
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-4 rounded-lg transition-colors duration-200"
                  >
                    Send Message
                  </button>
                </form>
